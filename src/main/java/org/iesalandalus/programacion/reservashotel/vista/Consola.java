...
public class Consola {
    ...
    public static Opcion elegirOpcion(){
        ...
        int numOpcion;
        do {
            System.out.println("Elige una opci�n insertando el número de dicha opción:");
    ...
    public static Reserva leerReserva() {
        ...
        try {
            ...
            System.out.println("Numero de huéspedes:");
            numeroPersonas = Entrada.entero();
            if (numeroPersonas <= 0) {
                throw new IllegalArgumentException("El n?mero de huéspedes debe ser mayor que cero.");
            }
